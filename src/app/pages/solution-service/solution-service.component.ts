...
@Component({
  selector: 'app-solution-service',
  templateUrl: './solution-service.component.html',
  styleUrls: ['./solution-service.component.scss']
})
export class SolutionServiceComponent implements OnInit {
